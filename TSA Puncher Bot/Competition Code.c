...
#pragma config(Motor,  port3,           motorsRight,   tmotorVex393HighSpeed_MC29, openLoop)
...
#pragma config(Motor,  port7,           motorsLeft,    tmotorVex393HighSpeed_MC29, openLoop, reversed)
