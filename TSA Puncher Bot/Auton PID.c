...
///////////////////////////////////////////////////////////////////////////////////
  ...
  // We start at 0 units and want to reach 100 units
  reqDistance = -6;
  targetDistance = reqDistance * (360/12.56);
...
///////////////////////////////////////////////////////////////////////////////////
  ...
  for(int i = 0; i < 200; i++)
  {
    ...
    // This calculates how far off we are from the true value
    //  The PID will return a response that will hopefully minimize this error over time
    float pidResult = PIDCompute(&pid1, targetDistance - (currentDistance*-1));

	    // Add pid to motor value
		motor[frontLeft]   = pidResult*1;
		motor[midLeft]     = pidResult*1;
		motor[backLeft]    = pidResult*1;
